...
public class GssDefine extends Node {
    ...
    public final void writeGssDefine(final ZippyBuffer writer, final boolean isExternal) throws IOException {
        if (isExternal) {
    ...
    public static GssDefine readGssDefine(final ZippyBuffer reader) throws IOException {
        final GssDefine packet = new GssDefine();
        int sector;
