...
public class IncludeInputFilter extends Node {
    ...
    public IncludeInputFilter() {
        super();
    }

    public IncludeInputFilter(List<InputFilterPattern> pattern) {
        super();
        this.pattern.addAll(pattern);
    }
    ...
    public final void writeIncludeInputFilter(final ZippyBuffer writer, final boolean isExternal) throws IOException {
        if (isExternal) {
    ...
    public static IncludeInputFilter readIncludeInputFilter(final ZippyBuffer reader) throws IOException {
        final IncludeInputFilter packet = new IncludeInputFilter();
        int sector;
