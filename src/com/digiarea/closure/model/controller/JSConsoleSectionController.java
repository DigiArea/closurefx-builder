 ...
 * @author daginno
 */
public class JSConsoleSectionController extends ClosureController implements Initializable, IConsole {
    ...
    public JSConsoleSectionController(ModelFacade modelFacade, ResourceBundle bundle) {
        super(modelFacade, bundle);
        modelFacade.setJsConsole(new JSCConsoleManager(this, modelFacade.getClosure(), bundle, modelFacade.getDocument().getPathResolver()));
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        controlProblemsKey.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ClosureStatus, String>, ObservableValue<String>>() {

            @Override
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ClosureStatus, String> p) {
                if (p.getValue() != null && p.getValue() instanceof JSCClosureStatus) {
                    JSCClosureStatus status = (JSCClosureStatus) p.getValue();
                    return new SimpleStringProperty(status.getDiagnosticType().key);
                } else {
                    return new SimpleStringProperty("<no type>");
                }
            }
        });
        controlProblemsKey.setCellFactory(new Callback<TableColumn<ClosureStatus, String>, TableCell<ClosureStatus, String>>() {
        ...
        controlProblemsType.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ClosureStatus, String>, ObservableValue<String>>() {
            ...
            public ObservableValue<String> call(TableColumn.CellDataFeatures<ClosureStatus, String> p) {
                if (p.getValue() != null) {
                    return new SimpleStringProperty("Closure Compiler Problem");
                } else {
                    return new SimpleStringProperty("<no line>");
                }
            }
    ...
    private class KeyCell extends com.digiarea.closure.model.controller.JSConsoleSectionController.TextCell {
        ...
        protected void updateItem(String item, boolean empty) {
            ...
            if (!isEmpty()) {
                ...
                if (getTableRow().getItem() instanceof JSCClosureStatus) {
                    final JSCClosureStatus status = (JSCClosureStatus) getTableRow().getItem();
                    hyperlink.setOnAction(new EventHandler<ActionEvent>() {

                        @Override
                        public void handle(ActionEvent arg0) {
                            HelpController help = ClosureFXController.APPLICATION.openHelp();
                            help.setInitialURL(HelpProvider.class.getResource(IConstants.HELP_COMPILER + "/closure-compiler-warnings.html"), "#" + status.getDiagnosticType().key);
                        }
                    });
                }
    ...
    public HBox create() throws Exception {
        ...
        Image image14 = new Image(getClass().getResource("/com/digiarea/closurefx/resources/launch.png").openStream());
        ...
        Image image15 = new Image(getClass().getResource("/com/digiarea/closurefx/resources/mark-error.png").openStream());
        ...
        Image image16 = new Image(getClass().getResource("/com/digiarea/closurefx/resources/launch.png").openStream());
        ...
        controlProblemsKey.setText(bundle.getString("ProgressDialog_Table_Warning"));
        ...
        Image image17 = new Image(getClass().getResource("/com/digiarea/closurefx/resources/mark-exclamation.png").openStream());
