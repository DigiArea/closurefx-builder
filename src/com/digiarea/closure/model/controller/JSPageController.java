 ...
 * @author daginno
 */
public class JSPageController extends ClosureController implements Initializable {
    ...
    public AnchorPane create() throws Exception {
        ...
        Image image27 = new Image(getClass().getResource("/com/digiarea/closurefx/resources/closure-white.png").openStream());
        ...
        Image image28 = new Image(getClass().getResource("/com/digiarea/closurefx/resources/launch-green.png").openStream());
        ...
        Image image29 = new Image(getClass().getResource("/com/digiarea/closurefx/resources/launch.png").openStream());
        ...
        AnchorPane info = ((JSInfoSectionController) modelFacade.getFactory().call(JSInfoSectionController.class)).create();
        VBox.setVgrow(info, Priority.NEVER);
        vBox35.getChildren().add(info);
        AnchorPane include5 = ((JSHelperSectionController) modelFacade.getFactory().call(JSHelperSectionController.class)).create();
        ...
        AnchorPane exports = ((JSExportsSectionController) modelFacade.getFactory().call(JSExportsSectionController.class)).create();
        VBox.setVgrow(exports, Priority.NEVER);
        vBox36.getChildren().add(exports);
        AnchorPane formatting = ((JSFormattingSectionController) modelFacade.getFactory().call(JSFormattingSectionController.class)).create();
        vBox36.getChildren().add(formatting);
        AnchorPane include6 = ((JSLanguageSectionController) modelFacade.getFactory().call(JSLanguageSectionController.class)).create();
        ...
        AnchorPane source = ((JSSourceSectionController) modelFacade.getFactory().call(JSSourceSectionController.class)).create();
        VBox.setVgrow(source, Priority.ALWAYS);
        vBox37.getChildren().add(source);
        AnchorPane order = ((JSOrderSectionController) modelFacade.getFactory().call(JSOrderSectionController.class)).create();
        ...
        AnchorPane include7 = ((JSLibrariesSectionController) modelFacade.getFactory().call(JSLibrariesSectionController.class)).create();
        VBox.setVgrow(include7, Priority.ALWAYS);
        vBox38.getChildren().add(include7);
        AnchorPane output = ((JSOutputSectionController) modelFacade.getFactory().call(JSOutputSectionController.class)).create();
        ...
        AnchorPane warnings = ((JSWarningsSectionController) modelFacade.getFactory().call(JSWarningsSectionController.class)).create();
        ...
        AnchorPane checks = ((JSCheckSectionController) modelFacade.getFactory().call(JSCheckSectionController.class)).create();
        ...
        AnchorPane renaming = ((JSRenamingSectionController) modelFacade.getFactory().call(JSRenamingSectionController.class)).create();
        ...
        AnchorPane sourceMap = ((JSSourceMapSectionController) modelFacade.getFactory().call(JSSourceMapSectionController.class)).create();
        vBox40.getChildren().add(sourceMap);
        AnchorPane defines = ((JSDefinesSectionController) modelFacade.getFactory().call(JSDefinesSectionController.class)).create();
        ...
        AnchorPane translation = ((JSTranslationSectionController) modelFacade.getFactory().call(JSTranslationSectionController.class)).create();
        vBox41.getChildren().add(translation);
        AnchorPane docs = ((JSDocsSectionController) modelFacade.getFactory().call(JSDocsSectionController.class)).create();
        ...
        HBox include8 = ((JSConsoleSectionController) modelFacade.getFactory().call(JSConsoleSectionController.class)).create();
