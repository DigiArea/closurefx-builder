...
import com.digiarea.closurefx.build.compiler.GSSExitCodeHandler;
...
public class GSSCompilerCli extends DefaultCommandLineCompiler {
	...
	public static void compile(ClosureGss closureGss,
			JobDescriptionBuilder builder, GSSPrintStreamErrorManager errorManager,
		...
		try {
			...
			GSSCompilerCli compiler = new GSSCompilerCli(builder.getJobDescription(),
